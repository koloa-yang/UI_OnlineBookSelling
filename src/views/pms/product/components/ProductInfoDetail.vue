<template>
  <div style="margin-top: 50px">
    <el-form :model="value" :rules="rules" ref="productInfoForm" label-width="120px" style="width: 600px" size="small">
      ...
      <el-form-item label="lsbn：" prop="lsbn">
        <el-input v-model="value.lsbn"></el-input>
      </el-form-item>
      <!--<el-form-item label="副标题：" prop="subTitle">-->
        <!--<el-input v-model="value.subTitle"></el-input>-->
      <!--</el-form-item>-->
      <el-form-item label="图书出版社：" prop="brandId">
        <el-input v-model="value.brandId"></el-input>
      </el-form-item>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          lsbn: [{required: true, message: '请输入lsbn编号', trigger: 'blur'}],
          version: [{required: true, message: '请输入书籍版本号', trigger: 'blur'}],
